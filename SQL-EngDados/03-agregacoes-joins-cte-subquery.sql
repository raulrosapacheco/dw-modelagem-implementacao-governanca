...
-- Tabela de projetos
CREATE TABLE estudos01.projetos (
    id_projeto INT PRIMARY KEY,
    nome_projeto VARCHAR(100),
    func_id INT REFERENCES estudos01.funcionarios(id_funcionario)
);

INSERT INTO estudos01.projetos (id_projeto, nome_projeto, func_id)
...
INNER JOIN estudos01.projetos p ON e.id_funcionario = p.func_id;

-- LEFT JOIN - Nome e salário de todos os funcionários independente de estarem alocados em projetos
SELECT e.nome, e.salario, p.nome_projeto
FROM estudos01.funcionarios e
LEFT JOIN estudos01.projetos p ON e.id_funcionario = p.func_id;
...
FROM estudos01.funcionarios e
RIGHT JOIN estudos01.projetos p ON e.id_funcionario = p.func_id;
...
FROM estudos01.funcionarios e
FULL JOIN estudos01.projetos p ON e.id_funcionario = p.func_id;
...
FROM estudos01.funcionarios
WHERE salario = (SELECT MAX(salario) FROM estudos01.funcionarios WHERE EXTRACT(MONTH FROM data_contratacao) = 2);
